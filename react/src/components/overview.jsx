...
class ConsumptionsGraph extends React.Component {
    ...
    changeTimeline() {
        ...
        this.setState({"timeline": timelines[new_id], "timeline_id": new_id, "timeline_name": timelines_names[new_id]});
    ...
    render() {
        return( <div style={{"backgroundColor": "white", "width": "80%", "margin": "auto"}}>
                    <div>
                        <button onClick={this.changeTimeline}>Par {this.state.timeline_name}.</button>
                    </div>
